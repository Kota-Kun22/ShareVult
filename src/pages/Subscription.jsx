...
const Subscription=()=>{
  ...
  console.log("🔧 Active menu prop:", "Subscription");

  
  console.log("🔧 Subscription component rendering");
  console.log("🔧 check it and remover it now Razorpay Key:", import.meta.env.VITE_RAZORPAY_KEY); // Add this line}
  
  
  // ... rest of your component
  //different plan that I am going to have 
      // Plans configuration
    const plans = [
        {
            id: "premium",
